...
class BroadLightNeutralRegionGuardTests(unittest.TestCase):
    @staticmethod
    ...
    def test_geometric_preprocess_restores_broad_light_neutral_fill(self) -> None:
        ...
        self.assertGreater(neutral[0][1], 4000)
        self.assertIn("restore_broad_light_neutral_regions", report["steps"])
    ...
    def test_thin_neutral_film_is_not_restored(self) -> None:
        ...
        restored, accepted = preprocess._restore_broad_light_neutral_regions(
            source,
            processed,
            scale=1,
        )

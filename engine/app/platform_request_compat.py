...
header when the immutable browser Origin exactly matches the request Host. The
identity middleware still verifies the token against the active SQLite session.
"""
